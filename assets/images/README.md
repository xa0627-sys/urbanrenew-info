# **中力都市更新資訊平台 (Zhongli Urban Renewal Info Platform)**
...
* **雲端圖庫整合**：直接串接 GitHub Repository 的圖片資源，無需額外設定圖床。  
...
2. **更換圖片**：  
   * 將新圖片上傳至 assets/images/ 資料夾。  
   * 在 index.html 中找到 IMG\_BASE\_URL 變數設定，或直接修改各區塊的圖片檔名。
