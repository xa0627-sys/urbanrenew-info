...
/*
 * 圖片顯示修復說明
 * 頁面中的圖片（在data.js中定義的選項卡圖片）應該放在以下位置：
 * - 本地開發: ./public/assets/images/
 * - GitHub Pages 部署: /urbanrenew-info/assets/images/
 * 請確保build過程中正確複製了assets/images目錄中的所有圖片到dist/public/
 */
